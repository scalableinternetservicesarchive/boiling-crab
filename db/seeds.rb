...
u5 = User.create(first_name: 'TEST', last_name: 'TEST', email: 'e@e', password: 'e', password_confirmation: 'e',
	nFollowing: 1, nFollower: 1, nPost: 1000,  nSold: 0, image: File.open("#{Rails.root}/public/images/question_mark.jpg"))
number_of_posts_per_user.times do
  ...
  post = Post.create(title: Faker::Lorem.word, description: Faker::Lorem.sentence,
    price: Faker::Number.number(3), user_id: u5.id, sell_to: -1,
