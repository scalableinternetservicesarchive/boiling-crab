...
p1 = Post.create(title: 'aa', description: 'aa', price: 1, user_id: u1.id, sell_to: -1)
p2 = Post.create(title: 'aaa', description: 'aaa', price: 1, user_id: u1.id, sell_to: -1)
p3 = Post.create(title: 'bb', description: 'bb', price: 1, user_id: u2.id, sell_to: -1)
p4 = Post.create(title: 'bbb', description: 'bbb', price: 1, user_id: u2.id, sell_to: -1)
p5 = Post.create(title: 'cc', description: 'cc', price: 1, user_id: u3.id, sell_to: -1)
p6 = Post.create(title: 'ccc', description: 'ccc', price: 1, user_id: u3.id, sell_to: -1)
p7 = Post.create(title: 'dd', description: 'dd', price: 1, user_id: u4.id, sell_to: -1)
p8 = Post.create(title: 'ddd', description: 'ddd', price: 1, user_id: u4.id, sell_to: -1)
